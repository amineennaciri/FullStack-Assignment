        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Gwala</span>
              <img
                className="h-8 w-auto"
                src="https://res.cloudinary.com/dsb3x6tva/image/upload/v1701616632/output-onlinepngtools_k4np6y.png"
                alt=""
              />
            </a>
          </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Click Here to Access the Github Repository of this Project.{' '}
              <a href="https://github.com/amineennaciri/FullStack-Assignment" className="font-semibold text-indigo-600">
